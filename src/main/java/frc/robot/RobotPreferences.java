...
public class RobotPreferences {
  ...
  public static final class prefArm {
    public static final SN_DoublePreference shoulderP = new SN_DoublePreference("shoulderP", 1);
    ...
    // degrees per second
    public static final SN_DoublePreference shoulderMaxSpeed = new SN_DoublePreference("shoulderMaxSpeed", 90);
    // degrees per second per second
    public static final SN_DoublePreference shoulderMaxAccel = new SN_DoublePreference("shoulderMaxAccel", 180);
    // degrees
    public static final SN_DoublePreference shoulderTolerance = new SN_DoublePreference("shoulderTolerance", 0.01);

    public static final SN_DoublePreference elbowP = new SN_DoublePreference("elbowP", 1);
    ...
    // degrees per second
    public static final SN_DoublePreference elbowMaxSpeed = new SN_DoublePreference("elbowMaxSpeed", 90);
    // degrees per second per second
    public static final SN_DoublePreference elbowMaxAccel = new SN_DoublePreference("elbowMaxAccel", 180);
    // degrees
