...
// pivotMotorConfig.forwardSoftLimitEnable =
// constCollector.PIVOT_FORWARD_LIMIT_ENABLE;
// pivotMotorConfig.reverseSoftLimitEnable =
// constCollector.PIVOT_REVERSE_LIMIT_ENABLE;
...
// pivotMotorConfig.slot0.closedLoopPeakOutput =
// prefCollector.pivotMaxSpeed.getValue();
...
// return Math.abs(getGoalPosition().getRadians() - getPivotMotorPosition()) <
// (Units
...
// prefCollector.rollerToleranceMultiplier.getValue()));
// }
...
// SmartDashboard.putNumber("Collector Pivot Motor Encoder",
// pivotMotor.getSelectedSensorPosition());
// SmartDashboard.putNumber("Collector Pivot Position",
// Units.radiansToDegrees(getPivotMotorPosition()));
// SmartDashboard.putNumber("Collector Pivot Absolute Encoder",
// getPivotAbsoluteEncoder().getDegrees());
// SmartDashboard.putNumber("Collector Pivot Absolute Encoder Raw",
// pivotAbsoluteEncoder.getAbsolutePosition());
// SmartDashboard.putNumber("Collector Pivot Absolute Encoder Raw Inverted",
// -pivotAbsoluteEncoder.getAbsolutePosition());
// SmartDashboard.putBoolean("Collector Pivot Is In Tolerance",
// isPivotMotorInTolerance());
// SmartDashboard.putNumber("Collector Goal Pivot Angle",
// getGoalPosition().getDegrees());

// SmartDashboard.putNumber("Collector Roller Motor Output",
// rollerMotor.getMotorOutputPercent());

// SmartDashboard.putNumber("Collector Pivot PID Error",
// SN_Math.falconToDegrees(pivotMotor.getClosedLoopError(),
// constCollector.GEAR_RATIO));
// }
// }
// }
